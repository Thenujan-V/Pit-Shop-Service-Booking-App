        ...
        http.csrf(AbstractHttpConfigurer::disable)
                .authorizeHttpRequests(authorizationManagerRequestMatcherRegistry ->
                        authorizationManagerRequestMatcherRegistry
                                ...
                                .requestMatchers("/api/v1/service-manager/edit-vehicle-count/{slotId}").permitAll()
                                .requestMatchers("/api/v1/services/create-services").permitAll()
                                .requestMatchers("/api/v1/services/get-services").permitAll()
                                .requestMatchers("/api/v1/services/delete-status/{service_id}").permitAll()
                                .requestMatchers("/api/v1/services/edit/{service_id}").permitAll()
